...
* add audit-fix target to Makefile and update dependencies in package.json and package-lock.json ([e373487](https://github.com/jger/triliza/commit/e3734879e513a1d06af7b06b3a70aaaa4fe9a49a))
